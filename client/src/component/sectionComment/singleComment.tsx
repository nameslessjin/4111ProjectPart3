...
export interface SingleCommentProps{
    comment: {username: string, text: string, date: string};
}

export default class SingleComment extends React.Component<SingleCommentProps> {
    static defaultProps = {
        comment: {}
    }
